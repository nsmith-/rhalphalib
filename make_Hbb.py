...
def dummy_rhalphabet(pseudo, throwPoisson, MCTF, scalesmear_syst, use_matched):
    ...
    sys_trigger = rl.NuisanceParameter('CMS_gghbb_trigger_2018', 'lnN')

    sys_ddxeff = rl.NuisanceParameter('CMS_eff_bb', 'lnN')
    sys_eleveto = rl.NuisanceParameter('CMS_gghbb_e_veto', 'lnN')
    sys_muveto = rl.NuisanceParameter('CMS_gghbb_m_veto', 'lnN')

    sys_veff = rl.NuisanceParameter('CMS_gghbb_veff', 'lnN')
    sys_wznormEW = rl.NuisanceParameter('CMS_gghbb_wznormEW', 'lnN')
    sys_znormEW = rl.NuisanceParameter('CMS_gghbb_znormEW', 'lnN')
    sys_znormQ = rl.NuisanceParameter('CMS_gghbb_znormQ', 'lnN')
